...
require (
	...
	github.com/babylonchain/babylon-finality-gadget v0.1.3-alpha.0.20240730030819-d80e151444f4
...
replace (
	...
	github.com/ethereum-optimism/optimism => github.com/babylonchain/optimism v1.7.5-0.20240730032532-6a13f1f9b07b
