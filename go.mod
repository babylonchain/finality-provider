...
require (
	...
	github.com/babylonchain/eots-aggregator v0.0.0-20240527183334-afdd4fb809d5
...
replace (
	...
	github.com/babylonchain/babylon => github.com/babylonchain/babylon-private v0.0.0-20240520231120-6364210f7701
