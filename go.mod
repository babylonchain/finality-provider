...
require (
	...
	github.com/cosmos/relayer/v2 v2.3.0-rc4.0.20230725195534-3c7828782d35
...
replace (
	github.com/babylonchain/babylon => github.com/babylonchain/babylon-private v0.0.0-20230726131422-eae9e1f1f69b
