...
func (v *ValidatorStored) GetBabylonPK() *secp256k1.PubKey {
...
func (v *ValidatorStored) GetBabylonPkHexString() string {
	return hex.EncodeToString(v.BabylonPk)
}

func (v *ValidatorStored) MustGetBTCPK() *btcec.PublicKey {
...
func (v *ValidatorStored) MustGetBIP340BTCPK() *bbn.BIP340PubKey {
	btcPK := v.MustGetBTCPK()
	return bbn.NewBIP340PubKeyFromBTCPK(btcPK)
}

func NewValidatorInfo(v *ValidatorStored) *ValidatorInfo {
