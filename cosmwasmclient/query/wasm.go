...
func (c *QueryClient) QueryWasm(
	f func(ctx context.Context, queryClient wasmtypes.QueryClient) error,
) error {
...
func (c *QueryClient) ListCodes(
	pagination *sdkquerytypes.PageRequest,
) (*wasmtypes.QueryCodesResponse, error) {
...
func (c *QueryClient) ListContractsByCode(
	codeID uint64,
	pagination *sdkquerytypes.PageRequest,
) (*wasmtypes.QueryContractsByCodeResponse, error) {
...
func (c *QueryClient) QuerySmartContractState(
